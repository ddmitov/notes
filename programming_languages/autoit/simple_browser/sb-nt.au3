...
If @OSType = "WIN32_WINDOWS" Then
   MsgBox (0+64, "Simple Browser", "Windows 95/98/ME detected! Please use Simple Browser for 9x based systems!")
   Exit
EndIf

; Read browser-nt.ini.
$engine = IniRead ("browser-nt.ini", "Simple_Browser", "engine", "mozilla")
$name = IniRead ("browser-nt.ini", "Simple_Browser", "name", "Simple Browser")
$host = IniRead ("browser-nt.ini", "Simple_Browser", "host", "localhost")
$port = IniRead ("browser-nt.ini", "Simple_Browser", "port", "80")
$index = IniRead ("browser-nt.ini", "Simple_Browser", "index", "index.htm")
